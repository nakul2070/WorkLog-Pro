/**
 * Database Migration Runner for Migration 008
 * Cleans up duplicate half-day leave entries
 */
...
async function runMigration008() {
  console.log('===========================================');
  console.log('🚀 Database Migration 008 Started');
  console.log('Cleaning up duplicate half-day leave entries');
  console.log('===========================================\n');
  ...
  try {
    ...
    const migrationPath = path.join(__dirname, '..', 'database', 'migrations', '008_cleanup_halfday_duplicate_entries.sql');
    ...
    if (failureCount === 0) {
      ...
      console.log('⚠️  Migration 008 Completed with Errors');
    }
    console.log('===========================================\n');
